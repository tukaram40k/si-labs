...
// hardware pin definitions (ESP32 GPIO)
#define PIN_LED1 16    // red led - status/toggle (GPIO12)
#define PIN_LED2 17    // green led - rapid blink (GPIO14)
#define PIN_LED3 18    // yellow led - heartbeat (GPIO27)
#define PIN_BUTTON 14   // button input (GPIO2)
